...
class _RoomTypeState extends State<StorageRoomType> with AutomaticKeepAliveClientMixin {
  ...
  Widget selectionRow({required String? text, required int? value, required int groupValue, required StorageRoomTypeData data}) {
    return Padding(
            ...
            child: Column(
              children: [
                ...
                buttonRow(widget.controller!, widget.currentPage!, nextButton: () {
                  ...
                  (data.roomType == 0) ? null : direction(widget.controller!, widget.currentPage!, true);
                })
              ],
            ),
          ),
